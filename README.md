# awesome-gnss with stars

##### Community list of open-source Global Navigation Satellite System (GNSS) software and resources :satellite:

Have something to add or change? Open a [pull request](https://github.com/barbeau/awesome-gnss/pulls) ⭐ 595 | 🐛 7 | 📅 2026-08-23 or [issue](https://github.com/barbeau/awesome-gnss/issues) ⭐ 595 | 🐛 7 | 📅 2026-08-23.
...
* **GPSTest** ([Google Play](https://play.google.com/store/apps/details?id=com.android.gpstest), [F-Droid](https://f-droid.org/packages/com.android.gpstest.osmdroid/), [Source code](https://github.com/barbeau/gpstest) ⭐ 2,374 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17) - Supports dual-frequency GNSS for GPS, GLONASS, QZSS, BeiDou/COMPASS, Galileo, IRNSS, as well as various SBAS systems. Supports measuring accuracy using a ground truth location and file logging for NMEA, raw measurements, navigation messages, and location data. Logs are compatible with Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 suite to [visualize data](https://developer.android.com/guide/topics/sensors/gnss#analyze).
* **GNSSLogger** ([Source code](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12) - Log raw measurements for visualization in Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 suite. No longer maintained by Google. A proprietary Google fork of the project can be downloaded from Google Play [here](https://play.google.com/store/apps/details?id=com.google.android.apps.location.gps.gnsslogger).
* **BasicAirData GPS Logger** ([Google Play](https://play.google.com/store/apps/details?id=eu.basicairdata.graziano.gpslogger), [Source code](https://github.com/BasicAirData/GPSLogger) ⭐ 499 | 🐛 65 | 🌐 Java | 📅 2026-05-25) - A GPS logger for Android mobile devices.
...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 725 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
* **Open GPX Tracker** ([App Store](https://apps.apple.com/app/open-gpx-tracker/id984503772), [Source code](https://github.com/merlos/iOS-Open-GPX-Tracker) ⭐ 717 | 🐛 78 | 🌐 Swift | 📅 2026-07-02) -  Open source GPX tracker app written in Swift.

### Desktop tools (open-source)

* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,115 | 🐛 455 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,214 | 🐛 235 | 🌐 C++ | 📅 2026-08-24) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 339 | 🐛 32 | 🌐 C++ | 📅 2026-08-24) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
* **gnssrefl** ([Source code](https://github.com/kristinemlarson/gnssrefl) ⭐ 216 | 🐛 4 | 🌐 Python | 📅 2026-08-20) - Open source GNSS software in python that supports estimation of water levels, soil moisture, and snow depth from reflected GNSS signals. Supports linux, Mac, and Windows (via docker).
* [FGI-GSRx](https://www.maanmittauslaitos.fi/en/fgi-gsrx-os) ([Source code](https://github.com/nlsfi/FGI-GSRx) ⭐ 189 | 🐛 12 | 🌐 MATLAB | 📅 2026-07-10) - An open-source software receiver in MATLAB used to develop, test and validate novel receiver processing algorithms for robust, resilient and precise Position, Navigation and Timing (PNT). Developed by the Finnish Geospatial Research Institute (FGI).
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 134 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,650 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2026-08-24 for GNSS processing.
* **RINEX-Cli** ([Download](https://github.com/georust/rinex/releases) ⭐ 125 | 🐛 27 | 🌐 Rust | 📅 2026-07-21) - An Open-source application to process RINEX data. It integrates several post processing algorithms,
...
* [gsdc2023](https://github.com/taroz/gsdc2023) ⭐ 112 | 🐛 3 | 🌐 MATLAB | 📅 2025-01-15 - Code for the [Google Smartphone Decimeter Challenge 2023](https://www.kaggle.com/competitions/smartphone-decimeter-2023) submission "An Open-Source Factor Graph Optimization Package for GNSS and IMU Integration in Smartphones" on Kaggle.
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,374 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 98 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,115 | 🐛 455 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
* [goGPS project](https://gogps-project.github.io/) - An open-source software package designed to improve the positioning accuracy of low-cost GPS devices by relative positioning. There are several versions, including [goGPS\_Java](https://github.com/goGPS-Project/goGPS_Java) ⭐ 65 | 🐛 14 | 🌐 Java | 📅 2025-03-13 and [goGPS\_MATLAB](https://github.com/goGPS-Project/goGPS_MATLAB) ⭐ 328 | 🐛 28 | 🌐 MATLAB | 📅 2025-05-28.
* [ge-drive-visualizer](https://github.com/taroz/ge-drive-visualizer) ⭐ 62 | 🐛 0 | 🌐 MATLAB | 📅 2025-03-24 - Visualizes the results of robot and vehicle position and pose estimation and lidar observations using Google Earth
* [GPSPACE](https://github.com/CGS-GIS/GPSPACE) ⚠️ Archived - Fortran script for Precise Point Positioning.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 20 | 🌐 Python | 📅 2026-08-24) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [gnss\_lib\_py](https://gnss-lib-py.readthedocs.io/en/latest/index.html#) - A modular Python tool for parsing, analyzing, and visualizing Global Navigation Satellite Systems (GNSS) data and state estimates by the Stanford NAV Lab.
...
* **AnyLocate** ([Download](https://anylocate.app)) - Software-defined GNSS signal simulator that drives a commodity SDR (HackRF, bladeRF, LimeSDR, ADALM-Pluto, USRP). Generates GPS, Galileo, GLONASS and BeiDou signals in real time, supports moving trajectories, and can record and replay live sky signals. Free tier available, paid tiers for longer daily runtime and additional constellations.
...
* [HowToCreate GPS/GNSS log file parser](http://www.howtocreate.co.uk/tutorials/jsexamples/gnsslogparser.html) - Upload gnss\_log output from GPSTest or Google's GnssLogger, or a CSV file containing the same columns. The tool processes the data, and applies a static Kalman filter to refine the position of the GNSS device, much better than basic averaging, since it can use the estimated accuracy for weighting.

### Libraries and interfaces

* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 316 | 🐛 31 | 🌐 C++ | 📅 2026-08-21 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 188 | 🐛 1 | 🌐 C++ | 📅 2026-08-24 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
* [GeoRust - RINEX](https://github.com/georust/rinex) ⭐ 125 | 🐛 27 | 🌐 Rust | 📅 2026-07-21 - RINEX files parsing and generation as a Rust library. Python bindings are under development.
...
* [gnss\_gpu](https://github.com/rsasaki0109/gnss_gpu) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-08-02 - GPU-accelerated GNSS positioning for dense urban areas, using CUDA particle filters with NLOS rejection based on ray tracing against 3D city models.
...
* [ntripstreams](https://github.com/stenseng/ntripstreams) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-07-12 - Python interface to transfer GNSS and related data between GNSS instruments, Ntrip caster and users using the [Ntrip protocol](https://gssc.esa.int/wp-content/uploads/2018/07/NtripDocumentation.pdf).
* [sidereon](https://github.com/neilberkman/sidereon) ⭐ 15 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 - One engine for GNSS positioning (SPP/RTK/PPP), astrodynamics (SGP4, conjunction, covariance propagation), and the data formats (RINEX 2/3/4, RTCM 3 MSM, SP3, NTRIP, NMEA, RINEX QC), with native Rust, Python, C, WebAssembly, and Elixir interfaces over a single Rust core. Cross-validated against Vallado, IGS, IERS, teqc, RTKLIB, and PROJ; in-browser demo at <https://sidereon.dev>.
* [GNSS - Rust](https://github.com/rtk-rs/gnss-rs) ⭐ 11 | 🐛 2 | 🌐 Rust | 📅 2026-06-10 - GNSS definitions in Rust. Includes detailed SBAS support.
* [tightly-coupled-gnss-imu-fgo](https://github.com/inuex35/tightly-coupled-gnss-imu-fgo) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Tightly-coupled GNSS RTK + IMU on GTSAM factor graphs: double-differenced code/carrier with LAMBDA ambiguity resolution and fix-and-hold, IMU preintegration, and between-satellite single-differenced Doppler. Results are reproducible end-to-end on the open PPC-Dataset urban Tokyo drives.
...
* [Kshana](https://github.com/AshfordeOU/kshana) ⭐ 6 | 🐛 2 | 🌐 Rust | 📅 2026-08-01 - Open, reproducible PNT-resilience simulator in Rust (with Python and WebAssembly bindings). SGP4/SDP4 orbits, IAU 2006/2000A reference frames, GNSS availability/DOP, GNSS/INS fusion, ARAIM/RAIM integrity, SBAS protection levels, and Allan deviations; SGP4 validated against all 666 AIAA 2006-6753 vectors. Includes RINEX/SP3/CCSDS interop and an in-browser playground at <https://kshana.dev>.
* [gps\_pvt](https://github.com/fenrir-naru/gps_pvt) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2026-08-24 - An Open Source Program Package for GNSS Positioning which is runnable and controllable via [Ruby](https://www.ruby-lang.org/). RINEX ver.2/3, SP3, ANTEX, and u-blox UBX parsers are included.

### Data

* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,374 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17.
* [UrbanNav](https://github.com/IPNL-POLYU/UrbanNavDataset) ⭐ 602 | 🐛 2 | 🌐 Python | 📅 2025-11-05 - An Open-Sourcing Localization Dataset Collected in Asian Urban Canyons, including Tokyo and Hong Kong.
...
* [*Android - Raw GNSS Measurements*](https://developer.android.com/guide/topics/sensors/gnss) by Google - Lists Android devices that support raw GNSS measurements as well as documentation for [GNSSLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 suite.
* [*GNSS Analysis Tools from Google*](https://insidegnss.com/gnss-analysis-tools-from-google/) by Inside GNSS - Discussion of Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 suite.
