...
* **Open GPX Tracker** ([App Store](https://apps.apple.com/app/open-gpx-tracker/id984503772), [Source code](https://github.com/merlos/iOS-Open-GPX-Tracker) ⭐ 718 | 🐛 78 | 🌐 Swift | 📅 2026-08-25) -  Open source GPX tracker app written in Swift.

### Desktop tools (open-source)

* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,117 | 🐛 455 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,216 | 🐛 235 | 🌐 C++ | 📅 2026-08-26) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 134 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,656 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-08-26 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,375 | 🐛 115 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 98 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,117 | 🐛 455 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 316 | 🐛 32 | 🌐 C++ | 📅 2026-08-21 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
...
* [sidereon](https://github.com/neilberkman/sidereon) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - One engine for GNSS positioning (SPP/RTK/PPP), astrodynamics (SGP4, conjunction, covariance propagation), and the data formats (RINEX 2/3/4, RTCM 3 MSM, SP3, NTRIP, NMEA, RINEX QC), with native Rust, Python, C, WebAssembly, and Elixir interfaces over a single Rust core. Cross-validated against Vallado, IGS, IERS, teqc, RTKLIB, and PROJ; in-browser demo at <https://sidereon.dev>.
* [tightly-coupled-gnss-imu-fgo](https://github.com/inuex35/tightly-coupled-gnss-imu-fgo) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Tightly-coupled GNSS RTK + IMU on GTSAM factor graphs: double-differenced code/carrier with LAMBDA ambiguity resolution and fix-and-hold, IMU preintegration, and between-satellite single-differenced Doppler. Results are reproducible end-to-end on the open PPC-Dataset urban Tokyo drives.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,375 | 🐛 115 | 🌐 Kotlin | 📅 2026-08-17.
