...
Have something to add or change? Open a [pull request](https://github.com/barbeau/awesome-gnss/pulls) ⭐ 597 | 🐛 7 | 📅 2026-08-23 or [issue](https://github.com/barbeau/awesome-gnss/issues) ⭐ 597 | 🐛 7 | 📅 2026-08-23.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,216 | 🐛 235 | 🌐 C++ | 📅 2026-08-25) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 134 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,652 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-08-25 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,374 | 🐛 115 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 19 | 🌐 Python | 📅 2026-08-25) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 187 | 🐛 1 | 🌐 C++ | 📅 2026-08-25 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,374 | 🐛 115 | 🌐 Kotlin | 📅 2026-08-17.
