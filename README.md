...
Have something to add or change? Open a [pull request](https://github.com/barbeau/awesome-gnss/pulls) ⭐ 588 | 🐛 7 | 📅 2026-08-23 or [issue](https://github.com/barbeau/awesome-gnss/issues) ⭐ 588 | 🐛 7 | 📅 2026-08-23.
...
* **Open GPX Tracker** ([App Store](https://apps.apple.com/app/open-gpx-tracker/id984503772), [Source code](https://github.com/merlos/iOS-Open-GPX-Tracker) ⭐ 717 | 🐛 77 | 🌐 Swift | 📅 2026-07-02) -  Open source GPX tracker app written in Swift.

### Desktop tools (open-source)

* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,112 | 🐛 455 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,211 | 🐛 236 | 🌐 C++ | 📅 2026-08-19) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 339 | 🐛 32 | 🌐 C++ | 📅 2026-08-21) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 133 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,646 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-08-23 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,373 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 98 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,112 | 🐛 455 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 19 | 🌐 Python | 📅 2026-08-13) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 186 | 🐛 1 | 🌐 C++ | 📅 2026-08-22 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
...
* [gnss\_gpu](https://github.com/rsasaki0109/gnss_gpu) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-02 - GPU-accelerated GNSS positioning for dense urban areas, using CUDA particle filters with NLOS rejection based on ray tracing against 3D city models.
...
* [sidereon](https://github.com/neilberkman/sidereon) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-08-23 - One engine for GNSS positioning (SPP/RTK/PPP), astrodynamics (SGP4, conjunction, covariance propagation), and the data formats (RINEX 2/3/4, RTCM 3 MSM, SP3, NTRIP, NMEA, RINEX QC), with native Rust, Python, C, WebAssembly, and Elixir interfaces over a single Rust core. Cross-validated against Vallado, IGS, IERS, teqc, RTKLIB, and PROJ; in-browser demo at <https://sidereon.dev>.
* [GNSS - Rust](https://github.com/rtk-rs/gnss-rs) ⭐ 11 | 🐛 2 | 🌐 Rust | 📅 2026-06-10 - GNSS definitions in Rust. Includes detailed SBAS support.
* [tightly-coupled-gnss-imu-fgo](https://github.com/inuex35/tightly-coupled-gnss-imu-fgo) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-08-23 - Tightly-coupled GNSS RTK + IMU on GTSAM factor graphs: double-differenced code/carrier with LAMBDA ambiguity resolution and fix-and-hold, IMU preintegration, and between-satellite single-differenced Doppler. Results are reproducible end-to-end on the open PPC-Dataset urban Tokyo drives.
...
* [gps\_pvt](https://github.com/fenrir-naru/gps_pvt) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2026-08-22 - An Open Source Program Package for GNSS Positioning which is runnable and controllable via [Ruby](https://www.ruby-lang.org/). RINEX ver.2/3, SP3, ANTEX, and u-blox UBX parsers are included.

### Data

* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,373 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17.
