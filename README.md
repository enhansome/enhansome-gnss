...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 722 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
* **Open GPX Tracker** ([App Store](https://apps.apple.com/app/open-gpx-tracker/id984503772), [Source code](https://github.com/merlos/iOS-Open-GPX-Tracker) ⭐ 715 | 🐛 73 | 🌐 Swift | 📅 2026-07-02) -  Open source GPX tracker app written in Swift.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,205 | 🐛 237 | 🌐 C++ | 📅 2026-08-09) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 133 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,634 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-08-16 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 840 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,364 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-16 to the RINEX format.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,364 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-16.
