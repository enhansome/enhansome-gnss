...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 731 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,235 | 🐛 239 | 🌐 C++ | 📅 2026-09-13) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,681 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-14 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,402 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-14 to the RINEX format.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 19 | 🌐 Python | 📅 2026-09-14) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 358 | 🐛 42 | 🌐 C++ | 📅 2026-09-14 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
...
* [gnss\_gpu](https://github.com/rsasaki0109/gnss_gpu) ⭐ 84 | 🐛 1 | 🌐 Python | 📅 2026-09-11 - GPU-accelerated GNSS positioning for dense urban areas, using CUDA particle filters with NLOS rejection based on ray tracing against 3D city models.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,402 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-14.
