...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 724 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,210 | 🐛 236 | 🌐 C++ | 📅 2026-08-19) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 338 | 🐛 33 | 🌐 C++ | 📅 2026-08-19) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 133 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,640 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-08-20 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 840 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,368 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 315 | 🐛 31 | 🌐 C++ | 📅 2026-08-19 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,368 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17.
