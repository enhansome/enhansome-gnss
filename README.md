...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 729 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,230 | 🐛 237 | 🌐 C++ | 📅 2026-09-10) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,677 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2026-09-10 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,394 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-02 to the RINEX format.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 20 | 🌐 Python | 📅 2026-09-10) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 354 | 🐛 29 | 🌐 C++ | 📅 2026-09-10 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 189 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
...
* [gnss\_gpu](https://github.com/rsasaki0109/gnss_gpu) ⭐ 83 | 🐛 1 | 🌐 Python | 📅 2026-08-28 - GPU-accelerated GNSS positioning for dense urban areas, using CUDA particle filters with NLOS rejection based on ray tracing against 3D city models.
* [RTK - Rust](https://github.com/rtk-rs/gnss-rtk) ⭐ 79 | 🐛 21 | 🌐 Rust | 📅 2026-09-10 - Precise Positioning in Rust.
