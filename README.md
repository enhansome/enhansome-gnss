...
* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,110 | 🐛 455 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 338 | 🐛 33 | 🌐 C++ | 📅 2026-08-21) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 133 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,642 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-08-21 for GNSS processing.
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 840 | 🐛 6 | 🌐 Java | 📅 2024-06-12 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,369 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 98 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,110 | 🐛 455 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 315 | 🐛 31 | 🌐 C++ | 📅 2026-08-21 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,369 | 🐛 113 | 🌐 Kotlin | 📅 2026-08-17.
