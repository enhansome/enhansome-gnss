...
Have something to add or change? Open a [pull request](https://github.com/barbeau/awesome-gnss/pulls) ⭐ 593 | 🐛 7 | 📅 2026-08-23 or [issue](https://github.com/barbeau/awesome-gnss/issues) ⭐ 593 | 🐛 7 | 📅 2026-08-23.
...
* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,114 | 🐛 455 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,214 | 🐛 236 | 🌐 C++ | 📅 2026-08-24) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 134 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,650 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-08-24 for GNSS processing.
...
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 98 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,114 | 🐛 455 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 187 | 🐛 1 | 🌐 C++ | 📅 2026-08-24 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
