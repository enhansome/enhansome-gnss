...
* **Open GPX Tracker** ([App Store](https://apps.apple.com/app/open-gpx-tracker/id984503772), [Source code](https://github.com/merlos/iOS-Open-GPX-Tracker) ⭐ 717 | 🐛 78 | 🌐 Swift | 📅 2026-08-25) -  Open source GPX tracker app written in Swift.
...
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,229 | 🐛 235 | 🌐 C++ | 📅 2026-09-07) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 342 | 🐛 33 | 🌐 C++ | 📅 2026-08-24) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 135 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,672 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-07 for GNSS processing.
* **RINEX-Cli** ([Download](https://github.com/georust/rinex/releases) ⭐ 126 | 🐛 35 | 🌐 Rust | 📅 2026-09-02) - An Open-source application to process RINEX data. It integrates several post processing algorithms,
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-06 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,393 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-02 to the RINEX format.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 20 | 🌐 Python | 📅 2026-09-03) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 348 | 🐛 36 | 🌐 C++ | 📅 2026-09-06 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 187 | 🐛 2 | 🌐 C++ | 📅 2026-09-01 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
* [GeoRust - RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 35 | 🌐 Rust | 📅 2026-09-02 - RINEX files parsing and generation as a Rust library. Python bindings are under development.
* [GeoRust - SINEX](https://github.com/georust/rinex/tree/main/sinex) ⭐ 126 | 🐛 35 | 🌐 Rust | 📅 2026-09-02 - SINEX files parsing.
* [GeoRust - SP3](https://github.com/georust/rinex/tree/main/sp3) ⭐ 126 | 🐛 35 | 🌐 Rust | 📅 2026-09-02 - SP3 Precise Orbits by IGS - files parsing and processing in Rust.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,393 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-02.
