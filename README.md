...
* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,125 | 🐛 456 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,230 | 🐛 236 | 🌐 C++ | 📅 2026-09-09) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
* **Google's GPS Measurement Tools suite** ([Download](https://github.com/google/gps-measurement-tools/releases) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08, [Source code](https://insidegnss.com/gnss-analysis-tools-from-google/)) - Desktop companion app for GNSSLogger to visualize and analyze raw measurements. Supports Windows, Mac, and Linux.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 135 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,674 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-09-09 for GNSS processing.
* **RINEX-Cli** ([Download](https://github.com/georust/rinex/releases) ⭐ 126 | 🐛 32 | 🌐 Rust | 📅 2026-09-09) - An Open-source application to process RINEX data. It integrates several post processing algorithms,
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,393 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-02 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 99 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,125 | 🐛 456 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* **prx** ([Source code](https://github.com/jtec/prx) ⭐ 23 | 🐛 20 | 🌐 Python | 📅 2026-09-09) - Reads a RINEX 3.05 observation file and outputs a CSV file.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 353 | 🐛 29 | 🌐 C++ | 📅 2026-09-09 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 189 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
* [GeoRust - RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 32 | 🌐 Rust | 📅 2026-09-09 - RINEX files parsing and generation as a Rust library. Python bindings are under development.
* [GeoRust - SINEX](https://github.com/georust/rinex/tree/main/sinex) ⭐ 126 | 🐛 32 | 🌐 Rust | 📅 2026-09-09 - SINEX files parsing.
* [GeoRust - SP3](https://github.com/georust/rinex/tree/main/sp3) ⭐ 126 | 🐛 32 | 🌐 Rust | 📅 2026-09-09 - SP3 Precise Orbits by IGS - files parsing and processing in Rust.
...
* [RTK - Rust](https://github.com/rtk-rs/gnss-rtk) ⭐ 79 | 🐛 21 | 🌐 Rust | 📅 2026-09-09 - Precise Positioning in Rust.
...
* [UrbanNav](https://github.com/IPNL-POLYU/UrbanNavDataset) ⭐ 605 | 🐛 2 | 🌐 Python | 📅 2025-11-05 - An Open-Sourcing Localization Dataset Collected in Asian Urban Canyons, including Tokyo and Hong Kong.
...
* [*Android - Raw GNSS Measurements*](https://developer.android.com/guide/topics/sensors/gnss) by Google - Lists Android devices that support raw GNSS measurements as well as documentation for [GNSSLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 suite.
* [*GNSS Analysis Tools from Google*](https://insidegnss.com/gnss-analysis-tools-from-google/) by Inside GNSS - Discussion of Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-08 suite.
