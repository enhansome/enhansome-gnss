...
* **Overland-iOS** ([App Store](https://apps.apple.com/us/app/overland-gps-tracker/id1292426766), [Source code](https://github.com/aaronpk/Overland-iOS) ⭐ 734 | 🐛 39 | 🌐 Objective-C | 📅 2025-10-23) - An experiment at gathering data from an iPhone to test the Core Location API and its various settings.
...
* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,138 | 🐛 457 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,280 | 🐛 239 | 🌐 C++ | 📅 2026-09-24) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* **Ginan** ([Source code](https://github.com/GeoscienceAustralia/ginan) ⭐ 343 | 🐛 31 | 🌐 C++ | 📅 2026-09-16) - A processing package being developed by [Geoscience Australia](http://www.ga.gov.au/) to provide real-time corrections to positioning data from the Global Navigation Satellite System (GNSS) constellations.
* **gnssrefl** ([Source code](https://github.com/kristinemlarson/gnssrefl) ⭐ 219 | 🐛 4 | 🌐 Python | 📅 2026-09-25) - Open source GNSS software in python that supports estimation of water levels, soil moisture, and snow depth from reflected GNSS signals. Supports linux, Mac, and Windows (via docker).
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 136 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,709 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-09-25 for GNSS processing.
* **RINEX-Cli** ([Download](https://github.com/georust/rinex/releases) ⭐ 128 | 🐛 30 | 🌐 Rust | 📅 2026-09-10) - An Open-source application to process RINEX data. It integrates several post processing algorithms,
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 843 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,410 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-21 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 100 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,138 | 🐛 457 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 367 | 🐛 42 | 🌐 C++ | 📅 2026-09-25 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
* [libgnss++](https://github.com/rsasaki0109/gnssplusplus-library) ⭐ 222 | 🐛 2 | 🌐 C++ | 📅 2026-09-25 - A modern C++20 GNSS toolkit for SPP, RTK, and PPP positioning, with Python bindings, Docker, and ROS 2 support.
* [GeoRust - RINEX](https://github.com/georust/rinex) ⭐ 128 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - RINEX files parsing and generation as a Rust library. Python bindings are under development.
* [GeoRust - SINEX](https://github.com/georust/rinex/tree/main/sinex) ⭐ 128 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - SINEX files parsing.
* [GeoRust - SP3](https://github.com/georust/rinex/tree/main/sp3) ⭐ 128 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - SP3 Precise Orbits by IGS - files parsing and processing in Rust.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,410 | 🐛 113 | 🌐 Kotlin | 📅 2026-09-21.
* [UrbanNav](https://github.com/IPNL-POLYU/UrbanNavDataset) ⭐ 611 | 🐛 1 | 🌐 Python | 📅 2025-11-05 - An Open-Sourcing Localization Dataset Collected in Asian Urban Canyons, including Tokyo and Hong Kong.
...
* [*Android - Raw GNSS Measurements*](https://developer.android.com/guide/topics/sensors/gnss) by Google - Lists Android devices that support raw GNSS measurements as well as documentation for [GNSSLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 843 | 🐛 6 | 🌐 Java | 📅 2026-09-08 and Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 843 | 🐛 6 | 🌐 Java | 📅 2026-09-08 suite.
* [*GNSS Analysis Tools from Google*](https://insidegnss.com/gnss-analysis-tools-from-google/) by Inside GNSS - Discussion of Google's [GPS Measurement Tools](https://github.com/google/gps-measurement-tools) ⭐ 843 | 🐛 6 | 🌐 Java | 📅 2026-09-08 suite.
