...
* **RTKLIB** ([Download](http://www.rtklib.com/), [Source code](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,122 | 🐛 456 | 🌐 C | 📅 2024-05-28) - An Open Source Program Package for GNSS Positioning. Has a companion Android app [RTKGPS+](https://play.google.com/store/apps/details?id=gpsplus.rtkgps). Supports Windows.
* **GNSS-SDR** ([Download](https://gnss-sdr.org/), [Source code](https://github.com/gnss-sdr/gnss-sdr) ⭐ 2,228 | 🐛 232 | 🌐 C++ | 📅 2026-09-05) - An open source GNSS software defined receiver. Supports Linux, Mac, and Windows.
...
* [gtsam\_gnss](https://github.com/taroz/gtsam_gnss) ⭐ 135 | 🐛 3 | 🌐 C++ | 📅 2026-05-23 - A set of custom factors and MATLAB wrappers that use [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,670 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-06 for GNSS processing.
* **RINEX-Cli** ([Download](https://github.com/georust/rinex/releases) ⭐ 126 | 🐛 29 | 🌐 Rust | 📅 2026-09-02) - An Open-source application to process RINEX data. It integrates several post processing algorithms,
...
* **Android GNSS Logger to RINEX converter** ([Source code](https://github.com/rokubun/android_rinex) ⭐ 104 | 🐛 7 | 🌐 Python | 📅 2024-06-24) - A Python script that converts raw measurements in the CSV format supported by [GnssLogger](https://github.com/google/gps-measurement-tools#gnsslogger) ⭐ 841 | 🐛 6 | 🌐 Java | 📅 2026-09-06 and [GPSTest](https://github.com/barbeau/gpstest) ⭐ 2,392 | 🐛 112 | 🌐 Kotlin | 📅 2026-09-02 to the RINEX format.
* [MatRTKLIB](https://github.com/taroz/MatRTKLIB) ⭐ 99 | 🐛 2 | 🌐 MATLAB | 📅 2025-03-08 - A MATLAB wrapper for [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,122 | 🐛 456 | 🌐 C | 📅 2024-05-28 and various processes required for actual GNSS analysis and research.
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 343 | 🐛 34 | 🌐 C++ | 📅 2026-09-06 - A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise estimation and outlier rejection for robust outdoor robot localization.
...
* [GeoRust - RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 29 | 🌐 Rust | 📅 2026-09-02 - RINEX files parsing and generation as a Rust library. Python bindings are under development.
* [GeoRust - SINEX](https://github.com/georust/rinex/tree/main/sinex) ⭐ 126 | 🐛 29 | 🌐 Rust | 📅 2026-09-02 - SINEX files parsing.
* [GeoRust - SP3](https://github.com/georust/rinex/tree/main/sp3) ⭐ 126 | 🐛 29 | 🌐 Rust | 📅 2026-09-02 - SP3 Precise Orbits by IGS - files parsing and processing in Rust.
* [gnss\_gpu](https://github.com/rsasaki0109/gnss_gpu) ⭐ 81 | 🐛 1 | 🌐 Python | 📅 2026-08-28 - GPU-accelerated GNSS positioning for dense urban areas, using CUDA particle filters with NLOS rejection based on ray tracing against 3D city models.
...
* [GPSTest Device Database](https://bit.ly/gpstest-device-database) - A list of device capabilities (e.g., supported GNSS constellations and carrier frequencies) crowd-sourced from users of the [GPSTest Android app](https://github.com/barbeau/gpstest) ⭐ 2,392 | 🐛 112 | 🌐 Kotlin | 📅 2026-09-02.
